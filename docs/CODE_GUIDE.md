...
| `ControlBar` | Bar bawah ala Meet: mic, kamera, layar, reaksi, captions, tangan, ⋮ More options (menu tunggal), end call + rail kanan Chat/People; menu ⋮ berisi recording, adjust view, fullscreen, PiP, background, report, help, settings. |
